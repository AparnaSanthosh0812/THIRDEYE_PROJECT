    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.province')),
            ],
        ),
        migrations.CreateModel(
            name='Login',
            fields=[
                ('User_Id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='mainapp.user')),
